...
public class InstanceOfValidatorTest {
	...
	@Test public void isValidTest() {
		List<Actor> actors = Arrays.asList(new Actor(1, "ActorOne", "agent"), new Actor(2, "ActorTwo", "agent"));
	...
	@Test public void isNotValidTest() {
		List<Actor> actors = Arrays.asList(new Actor(1, "ActorOne", "agent"), new Actor(2, "ActorTwo", "role"));
