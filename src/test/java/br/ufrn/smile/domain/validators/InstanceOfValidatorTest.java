...
public class InstanceOfValidatorTest {
	...
	@Test public void isValidTest() {
		List<Actor> actors = Arrays.asList(new Actor("ActorOne", "agent"), new Actor("ActorTwo", "agent"));
	...
	@Test public void isNotValidTest() {
		List<Actor> actors = Arrays.asList(new Actor("ActorOne", "agent"), new Actor("ActorTwo", "role"));
